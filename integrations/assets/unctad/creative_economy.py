...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.CreativeGoodsValueE.",
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.CreativeGoodsValueI.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.CreativeGoodsGR.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.CreativeGoodsIndex.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.CreativeServGroupE.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.CreativeServIndivTot.",
}, io_manager_key="vanilla_parquet_io_manager")
