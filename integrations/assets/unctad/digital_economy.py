...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctGoodsValue.",
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctGoodsShare.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctProductionSector.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctUseLocation.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctUseEnterprSize.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctUseEconActivity.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.IctUseEconActivityIsic4.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.DigitallyDeliverableService.",
}, io_manager_key="vanilla_parquet_io_manager")
...
@asset(metadata={
    ...
    "description": "This dataset was downloaded from UNCTADStat. More information about this dataset can be found at https://unctadstat.unctad.org/datacentre/reportInfo/US.TradeServICT.",
}, io_manager_key="vanilla_parquet_io_manager")
