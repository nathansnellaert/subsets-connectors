...
defs = Definitions(
    assets=fmp_daily_partition_assets + fmp_unpartitioned_assets + fmp_unpartitioned_assets + fred_assets + regular_assets + wikipedia_assets + internal_assets,
    jobs=[fmp_daily_partition_job, fmp_unpartitioned_job, fmp_unpartitioned_job, fred_job, regular_job, wikipedia_job, internal_job],
    resources={
